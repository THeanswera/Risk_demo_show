...
def render_scenarios() -> None:
    ...
    # ИСПРАВЛЕНО: tбл определяется по Приложению N 1, а не Приложению 6 (п. 20 Методики №1140)
    # Приложение 6 — это расчёт tр (расчётного времени эвакуации)
    st.info(
        "Время блокирования tбл определяется расчётом по Приложению N 1 Методики "
