...
def render_scenarios() -> None:
    ...
    st.caption(
        ...
        "(Приложение 3 или с помощью боковой панели), время присутствия людей tпр, время блокирования tбл, "
        "коэффициент АУП Kап (п. 15), и параметры  СПС/СОУЭ/ПДЗ (п. 41, 44, 45)."
    )
    
    st.info(
        "Время блокирования tбл определяется расчётом по приложению  1"
        "(п. 20) или моделированием (FDS/PyroSim). Используйте справочник в боковой панели "
